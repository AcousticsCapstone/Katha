...
function Quiz() {
  ...
  const [quizzes, setQuizzes] = useState<
    { _id: string; title: string; questions: Question[]; code: number }[]
  >([]);
  ...
  return (
    <div className="Quiz">
                  ...
                  <div key={index} className="question">
                    ...
                    {question.type === "openEnded" && (
                      <div className="form-group">
                        <label htmlFor={`question-${index}-textarea`}>
                          Your answer:{" "}
                          {/* Or you could use a more specific label */}
                        </label>
                        <textarea
                          id={`question-${index}-textarea`}
                          value={answers[index] ?? ""}
                          onChange={(e) =>
      ...
      {(userType === "teacher" || userType === "admin") &&
        quizzes.length === 0 && <h2>No quizzes found for this teacher.</h2>}
